...
def Proteome_Mass_ratio_of_total_amino_acids(fig_file,strain,analysis_result):
    ...
    pngname='%s/%s_twenty_amino_condition_boxplot.png'%(fig_file,strain)
...
def Proteome_Total_amino_acid_mass_of_protein(fig_file,strain,analysis_result,topnum,use_prot,protein_mass_norm_stat_std):
    ...
    pngname='%s/%s_twenty_amino_condition_boxplot_top%s_protein.png'%(fig_file,strain,topnum)
    draw_amino_mass_in_total_protein(amino_composition_norm_onecell_df,pngname)
...
def Proteome_High_protein_expression(topnum,fig_file,strain,analysis_result,use_prot):
    ...
    pngname='%s/%s_twenty_amino_condition_boxplot_intersection_protein.png'%(fig_file,strain)
    draw_amino_mass_in_total_protein(amino_composition_norm_onecell_df,pngname)
...
def Transcriptome(topnum,fig_file,strain,analysis_result):
    ...
    # 3.1转录组-质量总和超过50%的蛋白的氨基酸总质量
    use_prot = Transcriptome_Total_amino_acid_mass_of_protein(topnum,fig_file,strain,analysis_result)

    # 3.2转录组-质量总和超过50%的蛋白种表达变化比较大的蛋白
    topnum = Transcriptome_High_protein_expression(topnum,fig_file,strain,analysis_result,use_prot)
...
def main():
    ...
    if function == 'MW_Comparison':
        # 1.各物种蛋白MW比较
        # python draw_figure_in_article.py -fun 'MW_Comparison' -ff '../analysis_result/article_figures' -strains 'MG1655' 'Bacillus' 'Yeast_single_cell' 'Corynebacterium_RNA_seq' -strainName 'E. coli' 'B. subtilis' 'S. cerevisiae' 'C. glutamicum' -ar '../analysis_result/initial_data'
        ...
        # 2.BW25113蛋白组
        # python draw_figure_in_article.py -fun 'Proteome' -ff '../analysis_result/article_figures' -strains 'BW25113' -ar '../analysis_result/initial_data' -top 126
        print('----------------------------')
        ...
        # 3.BW25113转录组
        # python draw_figure_in_article.py -fun 'Transcriptome' -ff '../analysis_result/article_figures' -strains 'Bacillus' -ar '../analysis_result/initial_data' -top 1010
        print('----------------------------')
        strain = strain_list[0]
        print('strain: ',strain)
        print('----------------------------')
        ...
        # 4.物种比较  a.大肠杆菌其他几个菌株比较  b.其他物种比较
        ...
        # b.python draw_figure_in_article.py -fun 'Species_Comparison' -ff '../analysis_result/article_figures' -strains 'Corynebacterium_RNA_seq' 'BW25113' 'Bacillus' 'Yeast_single_cell' -strainName 'C. glutamicum' 'B. subtilis' 'E. coli' 'S. cerevisiae' -ar '../analysis_result/initial_data'
        print('----------------------------')
        print('strain_list: ',strain_list)
        print('strainName: ',strainName)
        print('----------------------------')
